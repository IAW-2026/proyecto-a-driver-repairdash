        ...
        {step ===
          ...
          <div className="flex flex-col items-center">
            ...
            <button
              ...
              className="group relative mt-10 h-32 w-32 overflow-hidden rounded-full border-2 border-dashed border-highlight/20 bg-highlight/[0.04] transition hover:border-accent/40 disabled:opacity-50"
            >
              {imageSrc ? (
                <img
                  src={
            ...
            {avatarPreview && (
              <p className="mt-3 text-xs text-highlight/45">
                Foto
                seleccionada
              </p>
            )}
      ...
      <div className="mt-auto flex items-center justify-between pt-10">
        {step > 0 ? (
          <button
            ...
            className="flex items-center gap-2 rounded-2xl border border-highlight/10 bg-highlight/[0.04] px-6 py-3 text-sm font-semibold text-highlight transition hover:bg-highlight/[0.08] disabled:opacity-40"
          >
